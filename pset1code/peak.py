...
class PeakProblem(object):
    ...
    def __init__(self, array, bounds):
        ...
        # print(f"The array in Peak problem is {array}")
    ...
    def getSubproblem(self, bounds):
        ...
        # print(f"self.startCol : {self.startCol}")
        # print(f"newBoinds : {newBounds}")
    ...
    def getSubproblemContaining(self, boundList, location):
        ...
        (row, col) = location
        # print(f"row in getSubproblemContaining: {row}   col : {col}")
        # print(f"boundlist in getSubprbContainign : {boundList}")
        for (sRow, sCol, nRow, nCol) in boundList:
            # print(sRow, sCol, nRow, nCol)
            
            # print(f"sRow : {sRow} row : {row} sRow + nRow : {sRow + nRow}")
            # print(f"sCol : {sCol} col : {col} sCol + nCol : {sCol + nCol}")
