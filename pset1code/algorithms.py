...
def algorithm1(problem, trace = None):
    ...
    # print(f"subNumC2 : {subNumC2}")
    # print(f"subStartR :  {subStartR}")
    # print(f"subStartC1: {subStartC1}")
    # print(f"subNumC1: {subNumC1}")
    # print(f"subStartC2 : {subStartC2}")
    # print(f"subNumR : {subNumR}")
    ...
    # print(f"sub.startCol : {sub.startCol}")
...
def algorithm3(problem, bestSeen = None, trace = None):
    ...
    # print(f"bestSeen: {bestSeen} value : {problem.get(bestSeen)}")
    ...
    # print(f"sub.startRow: {sub.startRow}" )
    # print(f"sub.startCol : {sub.startCol}")
    # print(f"sub.numRow : {sub.numRow}")
    # print(f"sub-array : {sub.array}")

    #TEST
    # test = []
    # for row in range(sub.startRow, sub.numRow + sub.startRow):
    #     Row = []
    #     for col in range(sub.startCol, sub.numCol + sub.startCol):
    #         Row.append(sub.array[row][col])
    #     test.append(Row)
    # print(f"sub Problem : {test}")
    #ENDTEST
